...
import type { AssistantMessage as SpinosaAssistantMessage, Message } from "@spinosa/sdk/v2"
...
export type AssistantTokenCost = Pick<SpinosaAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<SpinosaAssistantMessage, "role"> &
  Partial<Pick<SpinosaAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@spinosa/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@spinosa/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@spinosa/ACPUsage") {}
