...
Read in order:
1. AGENTS.md
2. framework/system/configuration.md
...
- change `setup_status: cli_started` to `setup_status: workspace_started` in framework/system/configuration.md and system/context.md,
