...
```bash
curl -fsSL https://github.com/TommasoPrinetti/pilosa/releases/download/v0.4.11/install.sh | bash -s -- --yes
```
...
```bash
curl -fsSL https://github.com/TommasoPrinetti/pilosa/releases/download/v0.4.11/install.sh -o install-pilosa.sh
