...
echo "    curl -fsSL https://github.com/TommasoPrinetti/spinosa/releases/download/v0.6.0/install.sh | bash" >&2
echo "    bash <(curl -fsSL https://github.com/TommasoPrinetti/spinosa/releases/download/v0.6.0/install.sh)" >&2
