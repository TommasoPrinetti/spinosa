...
1. Read `dictionary.md` to identify canonical terms and aliases for the topic.
...
5. Return located evidence with file paths and relevant excerpts.
...
- Always check dictionary before searching raw/ to get canonical terms.
...
- If no relevant sources exist, say so clearly.
