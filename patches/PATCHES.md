...
| `@opentui/solid` | 0.3.4 | Solid reconciler — reactive text attributes now clear stale bold/style flags; add jsx-runtime.js re-export for Bun's built-in JSX transform | Not upstreamed |
