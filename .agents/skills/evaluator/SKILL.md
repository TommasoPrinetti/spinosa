...
7. Write a structured audit report to `agent_reports/` using `references/audit-template.md`.
...
| File | Content |
|---|---|
| `references/audit-template.md` | Structured post-route audit template |
