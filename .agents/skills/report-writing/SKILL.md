...
See `references/chart-rendering.md` for full rendering specs for all chart types: Distribution Bars, Progress Bar, Status Matrix, Gauge, Sparkline, Stacked Bar.
...
**Common settings:** bar_width=16, border_style=`┌─ Title ─┐`, alignment=left+right, status=○→✓/⚠/✗
...
- `pilosa-orchestrator-dispatch` — for the goal-driven routing logic that invokes this skill

## References

| File | Content |
|---|---|
| `references/report-template.md` | Full report template with placeholders |
| `references/verbatim-format.md` | Verbatim quote format specification |
| `references/chart-rendering.md` | Unicode chart type rendering specs (all 6 types)
