...
import { ProviderPlugins } from "@spinosa/kernel-core/plugin/provider"
import { ZenmuxPlugin } from "@spinosa/kernel-core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://github.com/medialab/spinosa", "X-Title": "spinosa" })
