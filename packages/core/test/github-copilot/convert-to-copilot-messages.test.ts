import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@spinosa/kernel-core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
