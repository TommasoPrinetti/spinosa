...
export class Service extends Context.Service<Service, Interface>()("@spinosa/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.SPINOSA_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
