...
import { FileSystemWatcher } from "@spinosa/schema/filesystem-watcher"
...
declare const SPINOSA_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof SPINOSA_LIBC === "undefined" ? undefined : SPINOSA_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@spinosa/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.SPINOSA_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.SPINOSA_EXPERIMENTAL_FILEWATCHER) {
