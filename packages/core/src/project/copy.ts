...
import { Event } from "@spinosa/schema/project-directories"
import { ProjectCopy } from "@spinosa/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@spinosa/ProjectCopy") {}
