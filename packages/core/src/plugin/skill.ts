      ...
      draft.source(
        SkillV2.EmbeddedSource.make({
          ...
          skill: SkillV2.Info.make({
            ...
            description:
              "Use ONLY when the user is editing or creating spinosa's own configuration: spinosa.json, spinosa.jsonc, files under .spinosa/, or files under ~/.config/opencode/. Also use when creating or fixing spinosa agents, subagents, commands, skills, plugins, MCP servers, or permission rules. Do not use for the user's own application code, or for any project that is not configuring spinosa itself.",
