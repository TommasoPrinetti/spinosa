...
import { type Model } from "@spinosa/llm"
import * as AnthropicMessages from "@spinosa/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@spinosa/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@spinosa/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@spinosa/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@spinosa/v2/SessionRunnerModel") {}
