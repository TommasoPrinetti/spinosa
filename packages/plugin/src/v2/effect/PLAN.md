...
- Effect plugins import `@spinosa/plugin/v2/effect`, not `@spinosa/kernel-core`.
- Public domain values use generated `@spinosa/sdk` types.
...
- Define `PluginHost` domain capabilities in `@spinosa/plugin/v2/effect`.
