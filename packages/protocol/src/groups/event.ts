...
import type { Definition } from "@spinosa/schema/event"
...
export const SpinosaEvent = event.schema
export type SpinosaEvent = typeof SpinosaEvent.Type
export type SpinosaEventEncoded = typeof SpinosaEvent.Encoded
