...
import { AbsolutePath, NonNegativeInt, PositiveInt, RelativePath, statics } from "@spinosa/schema/schema"
      ...
      HttpApiEndpoint.post("session.interrupt", "/api/session/:sessionID/interrupt", {
        ...
        .annotateMerge(
          OpenApi.annotations({
            ...
            description: "Interrupt active execution owned by this Spinosa process. Idle interruption is a no-op.",
          }),
        ),
    )
    .add(
