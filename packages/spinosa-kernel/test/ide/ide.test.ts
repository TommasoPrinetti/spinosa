...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders SPINOSA_CALLER", () => {
    process.env["SPINOSA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode SPINOSA_CALLER", () => {
    process.env["SPINOSA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown SPINOSA_CALLER", () => {
    process.env["SPINOSA_CALLER"] = "unknown"
