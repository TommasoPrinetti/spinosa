...
describe("opencode read-only commands (smoke)", () => {
  ...
  // SPINOSA_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh SPINOSA_TEST_HOME means
  ...
  // in production it'd be a path under SPINOSA_TEST_HOME / XDG_DATA_HOME.
