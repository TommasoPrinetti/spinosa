...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@spinosa/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@spinosa/ACPDirectory") {}
