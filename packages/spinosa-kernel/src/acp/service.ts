...
import type { AssistantMessage, Message, OpencodeClient, SessionMessageResponse } from "@spinosa/sdk/v2"
...
export class Service extends Context.Service<Service, Interface>()("@spinosa/ACP/Service") {}
...
function fromUnknownError(error: unknown, service?: string): Error {
  ...
  return new ACPError.ServiceFailureError({ safeMessage: "Spinosa service failure", service })
}
