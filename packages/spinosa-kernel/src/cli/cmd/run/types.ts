...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@spinosa/sdk/v2"
...
export type FooterApi = {
  ...
  onQueuedSteer(fn: (messageID: string) => boolean | Promise<boolean>): () => void
