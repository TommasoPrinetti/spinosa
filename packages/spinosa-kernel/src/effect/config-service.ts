 ...
 *   "@spinosa/ServerAuthConfig",
 *   {
 *     password: Config.string("SPINOSA_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("SPINOSA_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
