...
import type { Model } from "@spinosa/sdk/v2"
import { InstallationVersion } from "@spinosa/kernel-core/installation/version"
import { OauthCallbackPage } from "@spinosa/kernel-core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Spinosa will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
