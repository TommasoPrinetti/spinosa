...
export class Service extends Context.Service<Service, Interface>()("@spinosa/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __SPINOSA_PHOTON_WASM_PATH?: string }).__SPINOSA_PHOTON_WASM_PATH =
