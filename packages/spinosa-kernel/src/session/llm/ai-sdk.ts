import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@spinosa/llm"
...
// Move this extraction into @spinosa/llm when Copilot is handled by the native runtime.
