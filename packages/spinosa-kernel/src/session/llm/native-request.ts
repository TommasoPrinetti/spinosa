import type { JsonSchema, LLMRequest, ProviderMetadata } from "@spinosa/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@spinosa/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @spinosa/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
