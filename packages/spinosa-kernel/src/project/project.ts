...
import { ProjectDirectoryTable, ProjectTable } from "@spinosa/kernel-core/project/sql"
import { ProjectDirectories } from "@spinosa/kernel-core/project/directories"
...
import { which } from "@spinosa/kernel-core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@spinosa/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.SPINOSA_FAKE_VCS)
