...
import { AccountStateTable, AccountTable } from "@spinosa/kernel-core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@spinosa/AccountRepo") {}
