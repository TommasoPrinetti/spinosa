...
import { LocationServiceMap } from "@spinosa/kernel-core/location-service-map"
...
export function createRoutes(password?: string) {
  return makeRoutes(
    password
      ? ServerAuth.Config.configLayer({ username: "spinosa", password: Option.some(password) })
      : ServerAuth.Config.layer,
  )
}

export function createEmbeddedRoutes() {
  return makeRoutes(ServerAuth.Config.configLayer({ username: "spinosa", password: Option.none() }))
}
