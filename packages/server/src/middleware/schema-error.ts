...
import { InvalidRequestError } from "@spinosa/protocol/errors"
import { SchemaErrorMiddleware } from "@spinosa/protocol/middleware/schema-error"
export { SchemaErrorMiddleware } from "@spinosa/protocol/middleware/schema-error"
